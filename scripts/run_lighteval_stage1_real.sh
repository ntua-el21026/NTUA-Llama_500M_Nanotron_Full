...
# Required by evaluation/run_eval_stage1.py / run_lighteval contract
...
SCORER_PY="$REPO_ROOT/scripts/run_lighteval_stage1_backend.py"
...
echo "[stage1-real] checkpoint=$CHECKPOINT_PATH"
echo "[stage1-real] step=$STEP"
echo "[stage1-real] eval_data_dir=$EVAL_DATA_DIR"
echo "[stage1-real] results_dir=$RESULTS_DIR"
echo "[stage1-real] tokenizer=$TOKENIZER_PATH"
echo "[stage1-real] seq_len=$SEQ_LEN"
echo "[stage1-real] batch_size=$EVAL_BATCH_SIZE"
echo "[stage1-real] nanotron_root=$NANOTRON_ROOT"
echo "[stage1-real] scorer=$SCORER_PY"
...
export STAGE1_EVAL_DATA_DIR="$EVAL_DATA_DIR"
export STAGE1_RESULTS_DIR="$RESULTS_DIR"
