...
def get_args():
    ...
    p1.add_argument("--dataset-config", type=str, default=None)
...
def main(args):
    if args.readers == "hf":
        ds_opts = {"split": args.split}
        if args.dataset_config is not None:
            ds_opts["name"] = args.dataset_config  # HuggingFace load_dataset(path, name=..., split=...
        ...
        datatrove_reader = SkippableHFReader(
            ...
            dataset_options=ds_opts, # Στέλνουμε καθαρό "train"
            streaming=True,
