...
# Required by evaluation/run_eval_stage4.py / run_lighteval contract
...
SCORER_PY="$REPO_ROOT/scripts/run_lighteval_stage4_backend.py"
...
echo "[stage4-real] checkpoint=$CHECKPOINT_PATH"
echo "[stage4-real] step=$STEP"
echo "[stage4-real] eval_data_dir=$EVAL_DATA_DIR"
echo "[stage4-real] results_dir=$RESULTS_DIR"
echo "[stage4-real] tokenizer=$TOKENIZER_PATH"
echo "[stage4-real] seq_len=$SEQ_LEN"
echo "[stage4-real] batch_size=$EVAL_BATCH_SIZE"
echo "[stage4-real] nanotron_root=$NANOTRON_ROOT"
echo "[stage4-real] scorer=$SCORER_PY"
...
export STAGE4_REPO_ROOT="$REPO_ROOT"
export STAGE4_EVAL_DATA_DIR="$EVAL_DATA_DIR"
export STAGE4_RESULTS_DIR="$RESULTS_DIR"
